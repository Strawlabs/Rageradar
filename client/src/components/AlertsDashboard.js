                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    {[
                      ...
                      { name: 'sms', icon: 'M12 18h.01M8 21l4-4 4 4M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', label: 'SMS' },
                      ...
                      <label key={channel.name} className="flex items-center space-x-3 opacity-50 cursor-not-allowed">
                        <input
                          type="checkbox"
                          disabled
                          className="w-4 h-4 text-slate-400 border-slate-600 rounded cursor-not-allowed"
                        />
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs bg-slate-600 text-slate-400 px-2 py-1 rounded-full">Coming Soon</span>
                        </div>
                      </label>
                    ))}
                  </div>
